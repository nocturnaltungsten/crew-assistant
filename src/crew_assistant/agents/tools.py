...
class ToolParameter:
    ...
    required: bool = True
    default: Any = None
    enum_values: Optional[List[str]] = None  # For restricted string values
...
class ToolRegistry:
    ...
    def fuzzy_match_tool(self, tool_name: str, threshold: float = 0.6) -> Optional[str]:
    ...
    def execute_tool(self, tool_call: ToolCall) -> ToolResult:
        ...
        if tool is None:
            ...
            if fuzzy_match:
                ...
                original_name = tool_call.tool_name
