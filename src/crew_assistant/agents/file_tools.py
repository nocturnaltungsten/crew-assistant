...
from .tools import BaseTool, ToolParameter, ToolResult, ToolCallStatus
...
class ReadFileTool(BaseTool):
    ...
    def execute(self, file_path: str, encoding: str = "utf-8", max_size_mb: float = 10) -> ToolResult:
...
class WriteFileTool(BaseTool):
    ...
    def execute(self, file_path: str, content: str, encoding: str = "utf-8", create_dirs: bool = False) -> ToolResult:
...
class ListDirectoryTool(BaseTool):
    ...
    def execute(self, dir_path: str = ".", show_hidden: bool = False, show_details: bool = False) -> ToolResult:
