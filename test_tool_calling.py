...
from crew_assistant.agents.file_tools import ListDirectoryTool, ReadFileTool, WriteFileTool
from crew_assistant.agents.tool_parser import ToolCallParser
from crew_assistant.agents.tools import default_registry
...
def test_file_operations():
    ...
    read_result = read_tool.safe_execute({"file_path": "/tmp/test_tool_file.txt"})
    ...
    list_result = list_tool.safe_execute({"dir_path": "/tmp", "show_details": False})
...
def test_agent_integration():
    ...
    from crew_assistant.agents.base import AgentConfig, BaseAgent
