...
class ToolCallParser:
    ...
    def _parse_markdown_blocks(self, text: str) -> Tuple[List[ToolCall], List[str], float]:
        ...
        for match in matches:
            ...
            if tool_name.lower() in ['python', 'javascript', 'bash', 'shell', 'json', 'yaml', 'xml']:
                continue
    ...
    def _parse_natural_language(self, text: str) -> Tuple[List[ToolCall], List[str], float]:
        ...
        action_indicators = [
            'create a file', 'write a file', 'save to file', 'make a file',
            'read the file', 'open the file', 'view the file', 'show me the file',
            'list the directory', 'show directory', 'list files'
        ]
        ...
        for tool_name in tool_names:
            ...
            for pattern in patterns:
                ...
                for match in matches:
                    ...
                    skip_indicators = ['<think>', 'would do', 'could do', 'should do', 
                                     'example', 'instructions', 'available tools']
    ...
    def _fix_malformed_json(self, json_str: str) -> Optional[ToolCall]:
    ...
    def _extract_call_from_dict(self, data: Dict[str, Any]) -> Optional[ToolCall]:
